...
public abstract class AbstractPlayerSpriteSheet extends SpriteSheet {
    ...
    public AbstractPlayerSpriteSheet(PlayerDisplayData data) {
        this.data = data;
    }
    ...
    public int getTextureId() {
        ...
        if (data.getVelocity().magnitude() >= MIN_ANIMATION_SPEED) {
            ...
            directionOffset += EFFECT_OFFSET * getEffectOffsetAmount();
    ...
    public abstract int getEffectOffsetAmount();
